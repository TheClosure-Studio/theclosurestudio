...
const FractalGlassHero = ({ imageUrl = "/export.png" }) => {
  ...
  if (webglFailed) {
    return (
      <section className="relative w-full h-[calc(100vh+40px)] bg-black flex items-center justify-center text-center text-white px-6">
        <div className="max-w-2xl space-y-4">
          <p className="text-sm uppercase tracking-[0.3em] text-white/60">
            Limited Device Mode
          </p>
          <h1 className="text-4xl md:text-6xl font-bold">
            We crafted an interactive hero, but your browser blocked WebGL to
            keep things running smoothly.
          </h1>
          <p className="text-lg text-white/80">
            You can still explore our work and services without the 3D glass
            effect. Try reloading or visiting on a device with WebGL enabled for
            the full experience.
          </p>
        </div>
      </section>
